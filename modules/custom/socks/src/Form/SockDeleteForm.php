...
/**
 * @file
 * Contains Drupal\socks\Form\SockDeleteForm.
 */
...
/**
 * Class SockDeleteForm.
 *
 * Provides a confirm form for deleting the entity. This is different from the
 * add and edit forms as it does not inherit from SockFormBase. The reason for
 ...
 * @ingroup socks
 */
class SockDeleteForm extends EntityConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to delete sock %label?', array(
  ...
  public function getCancelUrl() {
    return new Url('entity.sock.list');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    drupal_set_message($this->t('Sock %label was deleted.', array(
      '%label' => $this->entity->label(),
    )));
